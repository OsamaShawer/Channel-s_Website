      ...
      >
        ...
        <div className="mx-auto max-w-4xl pt-32 pb-24 text-center sm:pt-40 sm:pb-32">
          ...
          >
            ...
            development. It provides the structure and content for every website
            on the internet, making it essential for anyone looking to build web
            applications.
          </motion.p>
          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-base text-slate-300 leading-relaxed leading-relaxed">
                  Complete structured learning path covering HTML fundamentals,
                  semantic elements, forms, accessibility, and modern best
          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-base text-slate-300 leading-relaxed leading-relaxed">
                  Master HTML through engaging video tutorials with step-by-step
