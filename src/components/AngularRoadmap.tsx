    ...
    <main className="relative min-h-screen overflow-x-hidden overflow-y-visible bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white font-bold smooth-scroll">
      ...
      >
        ...
        <div className="mx-auto max-w-4xl pt-32 pb-24 text-center sm:pt-40 sm:pb-32">
          ...
          >
            Angular is a powerful, enterprise-grade framework for building
            large-scale web applications. Master TypeScript-based development
            with comprehensive tooling and robust architecture patterns.
          </motion.p>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            <motion.article
              ...
              whileHover={{ scale: 1.02, y: -4 }}
              whileTap={{ scale: 0.98 }}
              className="group relative rounded-3xl glass-card p-8 shadow-professional-lg backdrop-blur transition-all duration-100 hover:border-pink-300/50 hover:shadow-pink-200/20 overflow-hidden"
            >
              {/* Decorative gradient overlay */}
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-base text-slate-300 leading-relaxed leading-relaxed">
                  ...
                  fundamentals, TypeScript, components, services, routing, and
                  advanced features for building enterprise-scale applications.
                </p>
          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-base text-slate-300 leading-relaxed leading-relaxed">
                  Discover comprehensive explanations about Angular's history,
