    ...
    <main className="relative min-h-screen overflow-x-hidden overflow-y-visible bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white font-bold smooth-scroll">
      ...
      >
        ...
        <div className="mx-auto max-w-4xl pt-32 pb-24 text-center sm:pt-40 sm:pb-32">
          ...
          >
            JavaScript is the dynamic programming language that powers the
            modern web. Learn to build interactive websites, web applications,
            and even mobile apps with this versatile and essential programming
            language.
          </motion.p>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="mt-3 text-base text-slate-300 leading-relaxed leading-relaxed">
                      ...
                      that will strengthen your JavaScript skills and enhance
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-300 leading-relaxed">
              ...
              basics to advanced concepts and modern development practices.
            </p>
          </motion.div>
          <motion.div
            initial="hidden"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-base text-slate-300 leading-relaxed leading-relaxed">
                  ...
                  fundamentals, ES6+, DOM manipulation, async programming, and
                  modern frameworks for building dynamic web applications.
                </p>
